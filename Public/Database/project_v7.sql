...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 01, 2019 at 12:54 PM
...
INSERT INTO `lecturers` (`lecturerID`, `firstName`, `lastName`, `email`, `phoneNumber`, `roleID`, `userID`) VALUES
(1, 'พุทธิพร', 'ธนธรรมเมธี', 'putthiporn.th@wu.ac.th', 75672283, 2, '3'),
(2, 'เยาวเรศ', 'ศิริสถิตย์กุล', 'syaowara@wu.ac.th', 75672272, 2, '4');
...
INSERT INTO `teaching` (`courseID`, `lecturerID`, `roleID`) VALUES
(9, 1, 2),
(9, 2, 2);
...
(4, 'lecturers', '$2y$10$z0glw9l0y.YcYQGPmM7eCuRmuNoZgVED5YxP/yVKBkJYrFaaNIVpe', 2, 'lecturers');
